...
public UserInfo edit(@RequestBody UserInfo userinfo,@PathVariable("user_id") String user_id){
	System.out.println(user_id);
...
@RequestMapping(value="/users/{user_id}/idcards", method=RequestMethod.POST)
   public CardInfo addCard(@RequestBody CardInfo cardinfo, @PathVariable("user_id") String user_id){
...
@RequestMapping(value="/users/{user_id}/weblogins", method=RequestMethod.POST)
   public LoginInfo addLogin(@RequestBody LoginInfo logininfo, @PathVariable("user_id") String user_id){
...
@RequestMapping(value="/users/{user_id}/bankaccounts", method=RequestMethod.POST)
   public BankInfo addbank(@RequestBody BankInfo bankinfo, @PathVariable("user_id") String user_id){
